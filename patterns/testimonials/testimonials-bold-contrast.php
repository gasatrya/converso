 ...
 * Slug: converso/testimonials-bold-contrast
...
<div class="wp-block-group alignfull has-base-color has-contrast-background-color has-text-color has-background has-link-color"
	...
	<figure class="wp-block-image aligncenter size-full is-resized is-style-invert"><img
			src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/icons/icon-quote-top.svg'; ?>"
			alt="Quote top icon" style="width:60px" /></figure>
	<!-- /wp:image -->
	...
	<div class="wp-block-group"
		...
		<p class="has-text-align-center" style="font-size:60px;line-height:1">
			<?php echo esc_html__( 'Converso is the premier block theme for WordPress designers and developers, offering an extensive library of stylish patterns.', 'converso' ); ?>
		</p>
		<!-- /wp:paragraph -->
		<!-- wp:paragraph {"align":"center"} -->
		<p class="has-text-align-center"><?php echo esc_html__( 'Jennifer Kayne, Designer', 'converso' ); ?></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
	<!-- wp:image {"width":"60px","sizeSlug":"full","linkDestination":"none","align":"center","className":"is-style-invert"} -->
	<figure class="wp-block-image aligncenter size-full is-resized is-style-invert"><img
			src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/icons/icon-quote-bottom.svg'; ?>"
			alt="Quote bottom icon" style="width:60px" /></figure>
	<!-- /wp:image -->
</div>
<!-- /wp:group -->
