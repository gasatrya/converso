 ...
 * Slug: converso/about-split-contrast
...
<div class="wp-block-group alignfull has-base-color has-contrast-background-color has-text-color has-background has-link-color"
	...
	<div class="wp-block-columns alignwide are-vertically-aligned-top"
		...
		<div class="wp-block-column is-vertically-aligned-top">
			...
			<h2 class="wp-block-heading" style="font-size:48px;font-style:normal;font-weight:300">
		...
		<div class="wp-block-column is-vertically-aligned-top">
			<!-- wp:paragraph -->
			<p><?php echo esc_html__( 'We want to revolutionize how beautiful WordPress websites are made by embracing the power and flexibility of block-based design. Our approach transcends conventional standards and provides an innovative and imaginative canvas where creativity has no limits.', 'converso' ); ?>
			</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
