 ...
 * Slug: converso/featured-columns-contrast
 * Categories: converso-featured
 */
?>
<!-- wp:group {"metadata":{"name":"Feature Columns"},"align":"full","style":{"spacing":{"margin":{"top":"0"},"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"}},"elements":{"link":{"color":{"text":"var:preset|color|base"}}}},"backgroundColor":"contrast","textColor":"base","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull has-base-color has-contrast-background-color has-text-color has-background has-link-color"
	...
	<div class="wp-block-group alignwide">
		...
		<p class="has-x-small-font-size" style="font-style:normal;font-weight:400;text-transform:uppercase">
			<?php echo esc_html__( 'Meet Converso', 'converso' ); ?>
		</p>
		<!-- /wp:paragraph -->
	...
	<div class="wp-block-columns alignwide are-vertically-aligned-center"
		...
		<div class="wp-block-column is-vertically-aligned-center">
			...
			<h2 class="wp-block-heading" style="font-size:48px">
				<?php echo esc_html__( 'Design and build stunning websites with Converso.', 'converso' ); ?>
			</h2>
			<!-- /wp:heading -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column is-vertically-aligned-center">
			...
			<div class="wp-block-buttons">
				...
				<div class="wp-block-button"><a
						...
						href="#"
						style="padding-top:var(--wp--preset--spacing--medium);padding-right:var(--wp--preset--spacing--large);padding-bottom:var(--wp--preset--spacing--medium);padding-left:var(--wp--preset--spacing--large)"><?php echo esc_html__( 'Learn More →', 'converso' ); ?></a>
				</div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
	...
	<div class="wp-block-columns alignwide" style="margin-top:var(--wp--preset--spacing--80)">
		...
		<div class="wp-block-column">
			...
			<figure class="wp-block-image size-full"><img
					...
					alt="Sample image" /></figure>
			<!-- /wp:image -->
			<!-- wp:heading {"fontSize":"medium"} -->
			<h2 class="wp-block-heading has-medium-font-size"><?php echo esc_html__( 'Meet Converso', 'converso' ); ?>
			</h2>
			<!-- /wp:heading -->
			<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"5px"}}},"fontSize":"small"} -->
			<p class="has-small-font-size" style="margin-top:5px">
				<?php echo esc_html__( 'Are you ready to design with WordPress?', 'converso' ); ?>
			</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
