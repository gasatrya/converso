...
/**
 * Title: Footer - mega
 * Slug: converso/footer-mega-contrast
 * Categories: converso-footer
 * Block Types: core/template-part/footer
 */
?>
<!-- wp:group {"metadata":{"name":"Footer"},"align":"full","style":{"spacing":{"margin":{"top":"0"},"blockGap":"0px","padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"}},"elements":{"link":{"color":{"text":"var:preset|color|base"}}}},"backgroundColor":"contrast","textColor":"base","fontSize":"x-small","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull has-base-color has-contrast-background-color has-text-color has-background has-link-color has-x-small-font-size"
	...
	<div class="wp-block-group alignwide" style="padding-bottom:var(--wp--preset--spacing--60)">
		...
		<p class="has-text-align-center"><?php echo esc_html__( 'Made with Converso', 'converso' ); ?></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
	...
	<div class="wp-block-group alignwide"
		style="border-top-style:dotted;border-top-width:1px;border-bottom-style:dotted;border-bottom-width:1px;margin-top:0px;padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60)">
		...
		<div class="wp-block-columns are-vertically-aligned-center">
			...
			<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:30%">
				...
				<div class="wp-block-buttons">
					...
					<div class="wp-block-button aligncenter"><a
							...
							href="#"><?php echo esc_html__( 'Call to Action', 'converso' ); ?></a></div>
					<!-- /wp:button -->
				</div>
				<!-- /wp:buttons -->
			</div>
			...
			<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:40%">
				...
				<div class="wp-block-group"
					style="border-right-style:dotted;border-right-width:1px;border-left-style:dotted;border-left-width:1px">
					<!-- wp:paragraph {"align":"center"} -->
					<p class="has-text-align-center">
						<?php echo esc_html__( '“If you can dream it, you can do it.”', 'converso' ); ?>
					</p>
					<!-- /wp:paragraph -->
					<!-- wp:paragraph {"align":"center"} -->
