 ...
 * Slug: converso/call-to-action-outline-contrast
 * Categories: converso-call-to-action
 */
?>
...
<div class="wp-block-group alignfull has-base-color has-contrast-background-color has-text-color has-background has-link-color"
	...
	<div class="wp-block-group alignwide"
		style="border-width:1px;padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--80)">
		<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.25"},"layout":{"selfStretch":"fixed","flexSize":"680px"}},"fontSize":"x-large"} -->
		<p class="has-x-large-font-size" style="line-height:1.25">
			<?php echo esc_html__( 'We want to revolutionize how WordPress websites are made by embracing block-based design.', 'converso' ); ?>
		</p>
		<!-- /wp:paragraph -->
		<!-- wp:buttons -->
		<div class="wp-block-buttons">
			...
			<div class="wp-block-button"><a
					...
					href="#"
					style="padding-top:var(--wp--preset--spacing--medium);padding-right:var(--wp--preset--spacing--x-large);padding-bottom:var(--wp--preset--spacing--medium);padding-left:var(--wp--preset--spacing--x-large)"><?php echo esc_html__( 'Learn More →', 'converso' ); ?></a>
			</div>
			<!-- /wp:button -->
		</div>
		<!-- /wp:buttons -->
