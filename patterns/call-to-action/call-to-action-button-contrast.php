 ...
 * Slug: converso/call-to-action-button-contrast
	...
	<div class="wp-block-group alignwide">
		...
		<div class="wp-block-buttons">
			...
			<div class="wp-block-button has-custom-font-size has-small-font-size"><a
					class="wp-block-button__link has-contrast-color has-base-background-color has-text-color has-background has-link-color wp-element-button"><?php echo esc_html__( 'Learn More →', 'converso' ); ?></a>
			</div>
			<!-- /wp:button -->
		</div>
		<!-- /wp:buttons -->
