 ...
 * Slug: converso/hero-cover-stack-contrast
...
<div class="wp-block-cover alignfull has-base-color has-text-color" style="margin-top:0;min-height:600px"><span
		aria-hidden="true"
	...
	<div class="wp-block-cover__inner-container">
		...
		<div class="wp-block-group">
			...
			<h1 class="wp-block-heading" style="font-size:60px;font-style:normal;font-weight:300">
				<?php echo esc_html__( 'World-class interior design studio based in Laguna Beach.', 'converso' ); ?>
			</h1>
			<!-- /wp:heading -->
			...
			<div class="wp-block-group">
				...
				<p style="line-height:1">
					<?php echo esc_html__( 'Transform your space with our stylish design solutions.', 'converso' ); ?>
				</p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			...
			<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--60)">
				...
				<div class="wp-block-button"><a
						...
						href="#"><?php echo esc_html__( 'Start Project →', 'converso' ); ?></a></div>
				<!-- /wp:button -->
